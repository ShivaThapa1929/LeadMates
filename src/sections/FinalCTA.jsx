      ...
      <div className="relative max-w-4xl mx-auto z-10 text-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-8 mt-12">
            <Link
              to="/signup"
              className="group relative px-8 py-3 bg-blue-600 text-white rounded-full font-black text-sm transition-all flex items-center gap-2 overflow-hidden shadow-xl shadow-blue-600/20 hover:bg-blue-500"
            >
